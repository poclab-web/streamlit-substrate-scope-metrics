...
The web interface is available without installation:  
**https://substrate-scope-metrics.streamlit.app/**
...
```zsh
git clone https://github.com/poclab-web/streamlit-substrate-scope-metrics.git
```
```zsh
cd streamlit-substrate-scope-metrics
```
...
### Launch
```zsh
streamlit run substrate-scope-metrics.py
```
...
#### ECFP Settings
- You can change the radius and the number of bits in `Advanced settings` at the bottom of the `Home` page. The default values are radius 2 and 2048 bits.
...
This application is available under **[MIT License](https://github.com/poclab-web/streamlit-substrate-scope-metrics/blob/main/LICENSE)**.
